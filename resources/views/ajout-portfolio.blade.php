                                            ...
                                            <form action="addportfolio" method="post" enctype="multipart/form-data">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" type="text" name="categorie"  placeholder="categorie" id="example-text-input">
                                                    </div>
                                                     ...
                                                     <div class="mb-3">
                                                       ...
                                                       <textarea class="form-control" name="lien" placeholder="lien"></textarea>
                                                    </div>
