                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            <a href="index.html" class="logo logo-dark">
                                <span class="logo-sm">
                                    <img src="{{url('assets/images/logo-sm.svg')}}" alt="" height="30">
                                </span>
                                <span class="logo-lg">
                                    <img src="{{url('assets/images/logo-sm.svg')}}" alt="" height="24"> <span class="logo-txt">Dason</span>
                                </span>
                            </a>
                ...
                <div data-simplebar class="h-100">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="/ajout-auth" key="t-products">Ajouter</a></li>
                                    <li><a href="/liste-auth" data-key="t-product-detail">Liste</a></li>
                             ...
                             <li>
                                <a href="javascript: void(0);" class="has-arrow">
                                    <i data-feather="shopping-cart"></i>
                                    <span data-key="t-ecommerce">Info personnelles</span>
                                </a>
                                <ul class="sub-menu" aria-expanded="false">
                             ...
                             <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="/ajout-service" key="t-products">Ajouter</a></li>
                                    <li><a href="/liste-service" data-key="t-product-detail">Liste</a></li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="/ajout-contact" key="t-products">Ajouter</a></li>
                                    <li><a href="/liste-contact" data-key="t-product-detail">Liste</a></li>
                            ...
                            <li>
                                <a href="javascript: void(0);" class="has-arrow">
                                    <i data-feather="shopping-cart"></i>
                                    <span data-key="t-ecommerce">Skills</span>
                                </a>
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="/ajout-skill" key="t-products">Ajouter</a></li>
                                    <li><a href="/liste-skill" data-key="t-product-detail">Liste</a></li>
                            ...
                            <li>
                                <a href="javascript: void(0);" class="has-arrow">
                                    ...
                                    <span data-key="t-multi-level">Resume</span>
                                </a>
                                <ul class="sub-menu" aria-expanded="true">
                                <li>
                                        <a href="javascript: void(0);" class="has-arrow" data-key="t-level-1-2">education</a>
                                        <ul class="sub-menu" aria-expanded="true">
                                            <li><a href="/ajout-educ" data-key="t-level-2-1">ajouter</a></li>
                                            <li><a href="/liste-educ" data-key="t-level-2-2">Liste</a></li>
                                        </ul>
                                    </li>
                                    <li>
                                        <a href="javascript: void(0);" class="has-arrow" data-key="t-level-1-2">experience</a>
                                        <ul class="sub-menu" aria-expanded="true">
                                            <li><a href="/ajout-exp" data-key="t-level-2-1">ajouter</a></li>
                                            <li><a href="/liste-exp" data-key="t-level-2-2">Liste</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="/ajout-portfolio" key="t-products">Ajouter</a></li>
                                    <li><a href="/liste-portfolio" data-key="t-product-detail">Liste</a></li>
                        ...
                        <div class="card sidebar-alert shadow-none text-center mx-4 mb-0 mt-5">
                            <div class="card-body">
                                <img src="{{url('assets/images/giftbox.png')}}" alt="">
                                <div class="mt-4">
